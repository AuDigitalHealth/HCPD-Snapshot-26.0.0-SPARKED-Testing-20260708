# HCPD-Snapshot-26.0.0-SPARKED-Testing-20260708
...
How to Build
Pre-requisites
SUSHI - Ensure you have Node JS installed, and then install SUSHI via npm install -g fsh-sushi

Jekyll - Jekyll is a Ruby Gem and instructions are available for various operating systems.
...
License
This project is licensed under Creative Commons license 4.0 - see the LICENSE file for details.
